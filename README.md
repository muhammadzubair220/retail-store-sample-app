...
3. **Clone Repository**: `https://github.com/muhammadzubair220/retail-store-sample-app.git`
...
```sh
git clone https://github.com/muhammadzubair220/retail-store-sample-app.git
```
